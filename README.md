...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pytest-clarity-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=3263&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pytest-clarity-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pytest-clarity` can be installed with:

```
conda install pytest-clarity
```

It is possible to list all of the versions of `pytest-clarity` available on your platform with:
